...
@NonNull
@Override
public AllEventAdapter.EventViewHolder onCreateViewHolder(@NonNull ViewGroup parent, int viewType) {
    View view = LayoutInflater.from(context).inflate(R.layout.all_events_recycler, parent, false);
    return new AllEventAdapter.EventViewHolder(view);
}

@Override
public void onBindViewHolder(@NonNull AllEventAdapter.EventViewHolder holder, int position) {
